...
export const AuthPage = () => {
    ...
    const onAuthSubmit = () => {
        ...
        if (registerForm) {
            ...
            getFetch("https://localhost:7010/api/Auth/Register", "POST", JSON.stringify({ Name: name, Email: email, Password: password }))
                .then((response) => {
                    if (response.ok) {
            ...
            getFetch("https://localhost:7010/api/Auth/AccessToken", "POST", JSON.stringify({ Email: email, Password: password }))
                .then((response) => {
                    if (response.ok) {
